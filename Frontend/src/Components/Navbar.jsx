...
const Navbar = () => {
    ...
    const navItems = (
        <>
            <li className="rounded-md dark:hover:bg-pink-500 duration-200"><a href="/">Home</a></li>
            <li className="rounded-md dark:hover:bg-pink-500 duration-200"><a href="/profile">Profile</a></li>
            <li className="rounded-md dark:hover:bg-pink-500 duration-200"><a href="/books">Books</a></li>
            <li className="rounded-md dark:hover:bg-pink-500 duration-200"><a href="/about">About</a></li>
            <li className="rounded-md dark:hover:bg-pink-500 duration-200"><a href="/contact">Contact</a></li>
        </>
    )
    return (
        <>
            <div className={`max-w-screen-2x1 container mx-auto md:px-15 px-4 md:px-10 fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white ${sticky ? 'sticky-navbar shadow-md bg-base-200 dark:bg-slate-800 duration-300 transition-all  ease-in-out' : ''}`}>
                <div className="navbar"> 
                    <div className="navbar-start">
                        ...
                        <a className="text-2xl md:text-4xl font-bold cursor-pointer">bookStore</a>
                    </div>
