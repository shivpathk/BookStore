...
const About = () => {
  return (
    <>
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-7 pt-20">
            ...
            <div className="lg:flex lg:items-center">
                ...
                <div className="md:flex md:items-start md:-mx-4">
                  ...
                  <div className="mt-4 md:mx-4 md:mt-0">
                    ...
                    <p className="mt-3 text-gray-500 dark:text-gray-300">
                      So we have created the feature of reading the book online and if you wants to download the book and read it offline then you can download the book.
                    </p>
                  </div>
                </div>
                <div className="md:flex md:items-start md:-mx-4">
                  <div className="mt-4 md:mx-4 md:mt-0">
                    ...
                    <p className="mt-3 text-gray-500 dark:text-gray-300">
                      As we are not a company which just focuses on filling their own pocket, we give you all your favorite books completely free without any hiding cost.
                    </p>
                  </div>
                </div>
                <div className="md:flex md:items-start md:-mx-4">
                  <div className="mt-4 md:mx-4 md:mt-0">
                    ...
                    <p className="mt-3 text-gray-500 dark:text-gray-300">
                      Now nobody wants to damage their little pricius eyes so we have created a dark mode for you. And if you want to test the light mode you can switch it easily.
                    </p>
                  </div>
                </div>
              </div>
              <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
                <img
                  ...
                  src="https://img.freepik.com/free-vector/flat-world-book-day-illustration_23-2149311132.jpg?t=st=1730638965~exp=1730642565~hmac=e3b11499466d30a0402a429b2e48344243d9dd70ec4d9596cfd76088227c0d28&w=740"
                  alt=""
                />
              </div>
            </div>
